...
#WARNING: THIS WAS A QUICK FIX DEVELOPMENT. I DO NOT PLAN ON ENHANCING THIS BECAUSE IT ALREADY DOES WHAT I WANTED IT TO DO. FEEL FREE TO FORK. I'LL HAPPILY MENTION YOUR FORK IF IT HAS ADVANCED FEATURES
...
2. Navigate to:
   **Weather Services → Customized →
   Click Enable → Set Protocol Type Same As → MQTT**
